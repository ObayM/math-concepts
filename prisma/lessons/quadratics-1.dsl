...
param a = 1 in [-3,3] step 0.1
param b = 0 in [-6,6] step 0.5
param c = -2 in [-6,6] step 0.5
...
slider a "a — opens up/down & width"
slider b "b — shifts the vertex sideways"
slider c "c — the y-intercept"
...
param a = 1 in [-3,3] step 0.1
param h = 1 in [-5,5] step 0.1
param k = -2 in [-6,6] step 0.1
...
scene plane x:[-7,7] y:[-8,8] grid axes
param a = 0.5 in [-2,2] step 0.1
param r1 = -3 in [-6,6] step 0.1
param r2 = 2 in [-6,6] step 0.1
...
scene plane x:[-6,6] y:[-8,8] grid axes
param a = 1 in [-3,3] step 0.1
param b = 1 in [-6,6] step 0.5
param c = -3 in [-6,6] step 0.5
curve f = a*x^2 + b*x + c color:primary width:3
...
rect sq = (0, 0) (4, 4) color:primary opacity:0.18
label sql at (1.7, 2) "x²" color:primary size:22
rect st = (4.2, 0) (1.6, 4) color:accent opacity:0.22
label stl at (4.5, 2) "3x" color:accent size:16
rect st2 = (0, 4.2) (4, 1.6) color:success opacity:0.22
label st2l at (1.7, 4.9) "2x" color:success size:16
rect sm = (4.2, 4.2) (1.6, 1.6) color:warning opacity:0.3
...
scene plane x:[-7,7] y:[-8,8] grid axes
param a = 1 in [-3,3] step 0.1
param b = -4 in [-6,6] step 0.5
param c = 1 in [-6,6] step 0.5
curve f = a*x^2 + b*x + c color:primary width:3
point v = (-b/(2*a), c - b^2/(4*a)) color:accent r:7 label:"vertex"
