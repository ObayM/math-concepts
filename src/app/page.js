...
export default function Home() {
  ...
  return (
    <div className="min-h-[calc(100vh-var(--nav-h))] bg-surface text-neutral-900">
      <main>
        <section className="container mx-auto px-6 pt-32 pb-20 md:pt-48 md:pb-32">
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fade-in-up inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-50 border border-primary-100 text-primary-600 text-sm font-semibold mb-8">
